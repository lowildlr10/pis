...
class PDF extends TCPDF {
                    ...
                    if ($withColSpan) {
                        foreach ($columnDataKeys as $cKey) {
                            ...
                            if ($colSpanCount > 1) {
                                ...
                                $val = $row[$cKey];
                                $align = $aligns[$cKey];
                                $fontStyle = $this->htmlFontStyle(trim($dat['font-styles'][$cKey]));
                                $widthPercent += floatval($dat['widths'][$cKey]);
                            }
    ...
    public function header() {
        ...
        if ($this->headerIcon && $this->headerVerRev) {
            ...
            $this->Image('../resources/assets/images/dostlogo.jpg', $xCoor + 1, $yCoor, 16, 0,'JPEG');
