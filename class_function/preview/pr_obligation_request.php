...
function generateORS($pid, $conn, $dir, $increaseFontSize = 0, $pageHeight = 297, $pageWidth = 210) {
    ...
    $dataFooter = [
        [
            ...
            'font-styles' => ['', '', '', '', '', '', '', ''],
            'type' => 'other',
            'data' => [["Date", "Particulars", "ORS/JEV/Check/ADA/TRA No.", "Obligation <br><br>(a)", 
    ...
    $pdf->Cell($pageWidth * 0.5714, '8', "OBLIGATION REQUEST AND STATUS", "TLR", 0, "C");
    $pdf->Cell(0, '8', "", "TR");
    $pdf->Ln();
