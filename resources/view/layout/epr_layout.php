...
<form id="frmSize" name="frmSize" method="post" action="epr_preview.php" target="_blank">
...
<form id="frmSearch" name="frmSearch" method="post" action="search()" target="_blank">
	<div align="right" style="padding-right:6em;">
		<table border="0" cellspacing="1" cellpadding="4" id="tblPrint">
		    ...
		    <tr>
		    	<td>
		      		<select name="searchBy" id="searchBy"<?php echo $disable ?>>
					...
					<input type="text" name="txtSearch" placeholder="Search" width="70%">
