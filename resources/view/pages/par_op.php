...
if ($type == "old") {
    $qryInventoryItems = $conn->query("SELECT DISTINCT inv.propertyNo, issue.issueDate, issue.issuedBy, 
                                                       ...
                                                       item.amount, inv.id, issue.serialNo 
...
<table id="tblStyle" class="table">
    <tr>
        <th colspan="7">PROPERTY ACKNOWLEDGMENT RECEIPT</th>
    </tr>
    <tr>
        <td colspan="7">
            <div class="row">
                ...
                <div class="col-md-12 col-xs-12">
                    ...
                    <div class="col-md-5 col-xs-5">
                        <input class="form-control font-color-1" name="txtParNo" 
                               type="text" id="txtParNo" value="<?php echo $parNo ?>">
                    </div>
                </div>
        ...
        <td colspan="7">
            <table id="tbl-items" class="table table-bordered table-hover">
                <tr>
                    ...
                    <th width="10%" style="text-align: center;"> Unit </td>
                    <th width="40%" style="text-align: center;"> Description </td>
                    <th width="15%" style="text-align: center;"> Property Number </td>
                    <th width="14%" style="text-align: center;"> Date Acquired </td>
                    <th width="14%" style="text-align: center;"> Amount </td>
                    <th></th>
                </tr>
                ...
                if (mysqli_num_rows($qryInventoryItems)) {
                    ...
                    echo '<td>' . 
                         ...
                         '</td>';
                    echo '<td><input class="input-amount form-control required" type="text"></td>';
                    echo '<td style="text-align:center;">
